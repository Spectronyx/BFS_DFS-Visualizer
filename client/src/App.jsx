import { usePathfinding } from './hooks/usePathfinding.jsx';
import Grid from './components/Grid.jsx';
import ControlPanel from './components/ControlPanel.jsx';

/**
 * Main App Component - Pathfinding Algorithm Visualizer
 * This is the root component that brings together all parts of the application
 */
function App() {
  // Get all state and functions from the custom pathfinding hook
  const {
    gridState,
    handleCellClick,
    runBFS,
  ...
  // Function to generate helpful status messages for the user
  ...
  // Check if algorithms can be run (both start and end nodes set, not currently running)
  const canRunAlgorithm = gridState.startNode && gridState.endNode && !gridState.isRunning;

  return (
    <div className="min-h-screen flex flex-col lg:flex-row bg-gray-50">
      {/* Control Panel - Left sidebar with all controls and settings */}
      <ControlPanel
        mode={gridState.mode}
      ...
      {/* Main Content Area - Grid and information */}
      <div className="flex-1 p-6 overflow-auto">
        {/* Grid Header with instructions */}
        <div className="mb-6">
